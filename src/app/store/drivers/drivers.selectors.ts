...
// ========== Selectors Details
const selectDriverDetails = createSelector(
  selectDrivers,
  (state: DriversState) => state.details
);

// Items
export const selectDriverDetailsItems = createSelector(
  selectDriverDetails,
  (state: DriverDetailsState) => state.item
);

// Loading
export const selectDriverDetailsLoading = createSelector(
  selectDriverDetails,
  (state: DriverDetailsState) => state.loading
);

// Success
export const selectDriverDetailsSuccess = createSelector(
  selectDriverDetails,
  (state: DriverDetailsState) => state.success
);

// Error
export const selectDriverDetailsError = createSelector(
  selectDriverDetails,
  (state: DriverDetailsState) => state.error
);
